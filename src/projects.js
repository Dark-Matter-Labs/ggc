  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        xCategory: "Climate + Environmental + Economic",
        yCategory: "Market intervention: Data Infrastructure",
        description: "Copenhagen seeks to be a world-leading green and liveable city with a healthy and sustainable food system, but the city faces challenges in achieving this goal. While consulting oth- er cities and using Copenhagen as a prototype, the project Operationalizing Food System Targets for Health and Sus- tainability aims to enable cities to set smarter and more ambitious food system targets. The objective is to achieve greater accountability and measurable benefits to climate, environment, public health, and societal well-being. The project is the first to operationalise the science, paving the way for a planetary diet.",
      ...
      },
      {
        ...
        xCategory: "Climate + Environmental",
        yCategory: "Market intervention: Supply and Demand platform",
        description: "The collection of waste electrical and electronic equipment (WEEE) currently takes place through a complex chain that can leave space for illegal parallel channels. It is therefore necessary to improve the traceability of material flows and support cultural change through a reward system for virtu- ous behaviour. The InnoWEEE project intends to boost the collection of such waste through appropriate awareness and operative campaigns. It will help develop new business mod- els for municipalities and retailers to improve the collection of WEEE in cities, for example through smart bins.",
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        xCategory: "Climate + Environmental",
        yCategory: "Policy: Policy Framework",
        description: "Industry and investors increasingly demand a robust pol- icy framework to support the creation of markets for cli- mate-friendly materials. At the same time, policymakers require robust evidence for policies aligning carbon pricing with carbon leakage protection and equity concerns. Climate Friendly MaTeRials–mArket CreaTIon through pOlicy iNnovation (CFM TRACTION) engages a broad range of stakeholders to evaluate two key policy instruments: Climate Contribution for the automotive and construction sectors, and Project-based Carbon Contracts for Difference. The first instrument consists of a charge on carbon-intensive materi- als sold for final use in Europe. The second enables contracts between national governments and companies that ensure a guaranteed carbon price for a project. Together these in- struments can create lead markets as well as longer-term perspectives for the climate-neutral production and use of basic materials.",
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        xCategory: "Pure Climate",
        yCategory: "Market intervention: Risk Systems and Markets",
        description: "Short time horizons and the difficulty of estimating impacts based on near-term climate forecasts make it increasing- ly difficult for cities to act on climate change and related natural disasters. The project Climate Risk Information for SupportIngADAptation Planning and operaTion– Phase II (CRISI-ADAPT II) will develop an innovative tool to assess climate change impacts early on and prevent them at the local level. This tool aims to challenge cities to monitor and improve their adaptation planning. The project will focus on four strategic sectors: flooding/emergency response, water management for agriculture, energy planning and ports. This and other available tools and data will be used to support city governments, modellers, investors, and traders related to all sectors potentially affected by climate impacts.",
