...
const projects = [
  {
    ...
    data: [
      ...
      },
      {
        ...
        description:
          "Soils have vast potential to address climate change and advance a carbon-neutral or carbon-negative agriculture sector. Soil carbon sequestration (SCS) represents 90 per cent of the global agriculture sector’s potential to reduce greenhouse gas emissions. SCS is a natural process whereby CO2 is removed from the atmosphere and stored in a soil carbon pool. Carbon farming refers to a variety of agricultural methods for sequestering carbon in soils. The Carbon Farming project taps into the potential of SCS by working with farmers and the food industry to define and roll out new farming practices, and to scale these up as “transformative cases”. The project includes co-designing solutions with local stakeholders, developing monitoring and certification tools and identifying scaling mechanisms.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 103,
        y: 79,
    ...
    data: [
      {
        ...
        description:
          "London’s climate and environment sector is already worth £40 billion in sales per annum and is growing by over 10 per cent a year, according to Imperial College London. There are huge opportunities to accelerate this growth further utilising public sector procurement. CleanTech London: Demonstrating demand for net zero-carbon cities will assess London’s clean technology demand over the next 10 20 years and work with local authorities to accelerate the procurement of cleantech goods and services utilising Thirty3 a collaborative, city-wide procurement portal. The portal will facilitate the sharing of knowledge and learning amongst and across London’s boroughs and other public bodies in order to aggregate and identify demand, whilst simultaneously giving cleantech SME’s access to significant new aggregated procurement opportunities.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 120,
        ...
        description:
          "Currently less than 3 per cent of all homes in Europe have an A-energy label (which does not equal zero emissions) and more than 50 per cent are labelled G or worse. This means almost all homes in Europe need to be renovated. Current renovation rates are below 1 per cent per year and usually not focused on (near) zero emissions. Financing the renovation of individual homes is key, as homeowners are often reluctant to take out loans or can’t borrow the full amount needed. Loan repayments are also often due before borrowers reap full energy cost savings. RESETTLE! The ecosystem for financing near-energy-neutral home refurbishments aims to create inclusive financing instruments that will catalyse the financing of net zero home retrofits and make them scalable. It incorporates the perspectives of homeowners, funders and suppliers to solve the financing challenge.",
        link: "https://www.economicboardutrecht.nl/resettle",
      },
      {
        x: 103,
        y: 53,
        ...
        yCategory: "Market intervention: Finance instruments",
        description:
          "The European Commission’s European Green Deal estimates that achieving its 2030 climate and energy targets will require €260 billion of additional annual investment. The next years represent a critical window to shift financial flows toward this green transition. Priming Public Financial Institutions for Green Innovation (PUFFIN) aims to identify barriers to and enablers for financing the green transition and to use these insights to influence the missions, mandates, policies and activities of public sector financial institutions to align them with climate objectives. Specifically, the project works with central banks and national promotional banks, given their ability to act as catalysts to private financial markets.",
        link: "https://www.ucl.ac.uk",
      },
      {
        x: 94,
      ...
      },
      {
        ...
        yCategory: "Market intervention: Data Infrastructure",
        description:
          "Today, agriculture and forestry together account for over 20 per cent of global greenhouse gas emissions and are major drivers of soil and ecosystem degradation. Companies in crop-based industries that set ambitious environmental targets to reduce their footprint face massive data challenges in their supply chain management. Environmental data for agricultural production systems can be incomplete, inconsistent or too generic to identify hot spots and evaluate interventions meaningfully. GeoFootprint eases the burden of manually collecting and analysing sustainability metrics. The programme displays the best sources of publicly available environmental and crop production data on an intuitive and interactive online world map, delivering granular visibility (up to 10×10 km) that yields sharper insights for strategic decision-making.",
        link: "https://www.geofootprint.com",
      },
      {
        x: 86.5,
        y: 45,
        ...
        yCategory: "Market intervention: Data Infrastructure",
        description:
          "Copenhagen seeks to be a world-leading green and liveable city with a healthy and sustainable food system, but the city faces challenges in achieving this goal. While consulting other cities and using Copenhagen as a prototype, the project Operationalizing Food System Targets for Health and Sustainability aims to enable cities to set smarter and more ambitious food system targets. The objective is to achieve greater accountability and measurable benefits to climate, environment, public health, and societal well-being. The project is the first to operationalise the science, paving the way for a planetary diet.",
        link: "https://www.eatforum.org",
      },
      {
        x: 94,
        y: 52,
        ...
        yCategory: "Market intervention: Finance instruments",
        description:
          "Financial incentives that encourage farmers to adopt more resilient and sustainable practices could increase agricultural output in Africa and Europe and drive sustainability and climate resilience in the sector. The Agriculture Resilience, Inclusive, and Sustainable Enterprise (ARISE) project develops financial products to support long-term food security and establish de-risked value chains, based on farmers’ adoption of sustainable and climate-resilient crop practices and technologies.",
        link: "mailto:communitydesk@climate-kic.org ",
      },
      {
        x: 66,
        ...
        description:
          "Despite high demand among policymakers, city planners and building owners for more sustainable construction options, few approaches and processes exist for optimising wood usage in the construction sector. Research indicates that using wood could help reduce carbon emissions compared to other construction materials like concrete. Science-based methods for evaluating building sustainability could be one answer. The SMARTA Wood project aims to show how wood can be substituted in construction as an alternative for conventional materials like concrete. This project will develop a new decision-making tool that evaluates and provides indicators on the sustainability impact of wood construction technologies. Taken to market, this tool would be useful for municipal authorities, construction companies, building owners/developers, architects, and environmental experts",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 62.5,
        ...
        yCategory: "Market intervention: Supply and Demand platform",
        description:
          "The collection of waste electrical and electronic equipment (WEEE) currently takes place through a complex chain that can leave space for illegal parallel channels. It is therefore necessary to improve the traceability of material flows and support cultural change through a reward system for virtuous behaviour. The InnoWEEE project intends to boost the collection of such waste through appropriate awareness and operative campaigns. It will help develop new business models for municipalities and retailers to improve the collection of WEEE in cities, for example through smart bins.",
        link: "https://www.innoweee.eu",
      },
      {
        x: 72.5,
        y: 46.5,
        ...
        yCategory: "Market intervention: Supply and Demand platform",
        description:
          "Fruit supply chains are already experiencing the negative impact of a warming climate and environmental degradation, particularly of soil. Early and erratic crop flowering, the reduction of fruit quality, the emergence of new diseases and water supply issues, as well as rising demand for inputs to sustain production all present unique challenges. Current fruit crop production uses high levels of polluting products in the form of pesticides and fertiliser. Sustainable initiatives like water management, improvements in soil quality, biodiversity protection and carbon capture can reduce greenhouse gas emissions across supply chains in the sector. The Friendly Fruit project aims to test environment-friendly agricultural practices in various regions and set up an appropriate structure to define, test, and promote them, starting with strawberries and apples. Several innovations are being introduced, such as pest-resistant and high-performing fruit varieties, mechanical weeding systems intended to decrease herbicide use, better management of fertilization, and subsoil smart-sensors that monitor water levels.",
        link: "https://www.agrisource.org",
      },
      {
        x: 61.5,
        y: 37,
        ...
        yCategory: "Market intervention: Data Infrastructure",
        description:
          "Forests have been on the front lines of climate change action recently. Yet views diverge on their role – whether as carbon sinks that require conservation and restoration, or as sources of wood products that store carbon and substitute fossil-based materials. A holistic perspective is needed to support policymaking, investment decisions and actions that balance the function of forests and wood products for climate and biodiversity benefits. The 3S Framework for Forests project aims to develop an instrument for actors across multiple sectors to assess how their choices can maximise the climate change impact of forests and sustainable forest products. The instrument will help compare different scenarios in terms of carbon absorption and sequestration (the sink function), carbon storage (the biocarbon stored in wood-based products) and carbon substitution (the fossil carbon emissions avoided).",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 128.5,
        ...
        yCategory: "Market intervention: Finance instruments",
        description:
          "Our cities are packed with a diversity of assets and shared resources – parks, schools, public transport, energy systems, collective intelligence and data. They are the foundation of our current and future wealth, and they mitigate against future shared risks. Society recognises the value of such civic assets, but we are failing to preserve and enhance them and to provide the capital to secure their future. The project Re-Coding for a Civic Capital Economy (RE.CO) will design new investment models to steer capital toward civic goods and create public value. The core project aim is to demonstrate how a next generation of coding tools (e.g. smart contracts, real-time sensor data, etc.) can bring about a shift in our economy, unlocking new financial, regulatory and legal instruments that preserve and enhance public goods. The project aims to develop a proof of possibilities across five different areas (contracts, trees, streets, floods and urban data) and build the case for transformative ‘civic asset business models’ that alter how we deploy capital for shared civic benefit.",
        link: "https://www.darkmatterlabs.org",
      },
      {
        x: 105.5,
        y: 41,
        ...
        yCategory: "Market intervention: Data Infrastructure",
        description:
          "There is an ocean of available capital that could address today’s environmental crisis. Unfortunately, the absence of a reliable flow of data leads to the misallocation of resources, missed opportunities and creates huge risks on our global balance sheets. The problem is not the technology, but the culture – organisations are stuck in ‘closed’ models, negotiating case-by-case. In April 2020, Icebreaker One launched SERI (Standard for Environmental Risk and Insurance), intending to build the shared data infrastructure that’s needed to deliver net zero across financial services, including insurance. SERI brings together partner organisations and leading institutions to create bridges across which finance and climate change data can flow. The project will develop financial products that will deliver demonstrable net-zero outcomes, alongside the shared data infrastructure underpinning them.",
        link: "https://www.icebreakerone.org",
      },
      {
        x: 60,
        y: 62.5,
        ...
        description:
          "Over 30 per cent of plastic used worldwide escapes waste management systems, with a serious negative impact on the environment, while 95 per cent of plastic packaging material value is lost after its first use. In recent years, a greater understanding of the impact of plastic waste has led to many initiatives, alliances and projects, as well as an unprecedented number of commitments from companies seeking to develop circular, zero-waste plastic value chains. Despite this momentum, practical strategies for achieving zero waste or ‘100% circular plastics’ are scarce. The Catalysing Corporate Action Through Plastic Standards (CCAPS) project contributes to the development of standards and guidelines for corporates and for plastic intervention projects. It is also developing a concept for a Plastic Action Fund to provide pre-financing for plastic recovery and recycling infrastructure in developing countries.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 83,
        ...
        description:
          "Most financial advisors do not ask about their clients’ sustainability preferences and often have trouble identifying and recommending suitable products. The Elicit Sustainability Investment Preferences project wants to establish and implement a scientific method to assess individuals’ sustainability investment objectives. This method should also evaluate how financial advisors affect their clients’ decisions. To achieve this, the team will implement behavioural finance field experiments involving thousands of individuals, field visits involving hundreds of financial advisors and an online experiment involving both groups. The results will help to estimate the demand for sustainable investment products and understand the behavioural barriers to investing in these products. These insights will be used to develop a market research toolbox for investment product retailers.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 129.5,
    ...
    data: [
      {
        ...
        description:
          "Urban citizens and policymakers often do not know how to access climate risk information and use it to make decisions. The Urban Climate Action Starter Kit seeks to develop a range of materials, youth training modules, experiential learning activities and public engagement events to help people make informed decisions about climate risks. These materials and activities will help to expand the availability of current climate data and help businesses, civil society, academia and government stakeholders to understand the emerging climate challenges.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 31,
        ...
        yCategory: "Policy: Policy Framework",
        description:
          "In Europe, there is enough residual heat in to warm the continent’s entire building stock and plenty of solutions to cut reliance on primary energy sources and thus C02 emissions. District heating, for example, pipes residual heat from a city’s electricity production into local buildings. But its average heating market share is only 10 per cent. The Celsius 2.0 project aims to accelerate the energy transition by deploying smart and sustainable heating and cooling solutions in cities. Through its digital Celsius Toolbox, where stakeholders can connect, exchange ideas and foster innovation, the project supports knowledge-sharing and increases awareness of sustainable heating solutions. Celsius 2.0 also weighs in on European policymaking, supporting a legislative framework that empowers cities to pursue ambitious projects and policies that will reduce their carbon emissions footprint.",
        link: "https://www.celsiuscity.eu",
      },
      {
        x: 29,
        y: 84,
        ...
        yCategory: "Micro Demonstration",
        description:
          "DRIVE 2 is a transport system demonstration project developed within the EU’s Horizon 2020 Easily diStributed Personal RapId Transit (ESPRIT) initiative. It enables users to drive an electric carsharing vehicle the short distance to and from public transportation. ESPRIT is a light vehicle based on an electric quadricycle, which can be nested together and distributed as a road train of eight to ten vehicles. ESPRIT could efficiently complement public transport by comprising between 5 and 20 per cent of all trips, depending on the configuration. To address this potential, the system will go through various evaluations based on two demonstrations taking place in Lyon with 150 people.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 37,
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        description:
          "Carbon emissions from existing homes are probably the single biggest challenge facing the UK, and indeed much of Europe, in the transition to net zero. There is a systemic failure in tackling this challenge, compounded by piecemeal national policy, difficulties in engaging households to stimulate demand and a lack of sustainable business models. The Accelerator Cities Programme will help cities develop their own programmes for retrofitting homes to make them more energy efficient. It aims to unlock system change through coordinated action in and between cities that addresses barriers to retrofitting buildings. The project will build cities’ capacity and capability to respond. In addition to sharing best practices, the programme will develop a coordinated approach for cities to link with financial institutions and funding opportunities.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 63,
      ...
      },
      {
        ...
        yCategory: "Policy: Policy Framework",
        description:
          "Industry and investors increasingly demand a robust policy framework to support the creation of markets for climate-friendly materials. At the same time, policymakers require robust evidence for policies aligning carbon pricing with carbon leakage protection and equity concerns. Climate Friendly MaTeRials–mArket CreaTIon through pOlicy iNnovation (CFM TRACTION) engages a broad range of stakeholders to evaluate two key policy instruments: Climate Contribution for the automotive and construction sectors, and Project-based Carbon Contracts for Difference. The first instrument consists of a charge on carbon-intensive materials sold for final use in Europe. The second enables contracts between national governments and companies that ensure a guaranteed carbon price for a project. Together these instruments can create lead markets as well as longer-term perspectives for the climate-neutral production and use of basic materials.",
        link: "https://www.climatestrategies.org",
      },
    ],
  },
  {
    ...
    data: [
      {
        ...
        yCategory: "Micro Demonstration",
        description:
          "The Green Energy Community (GECO) project is a real-life sustainable energy experiment in the Pilastro – Roveri districts of Bologna. The project will establish and manage an energy community and provide energy services to its members in order to increase sustainability, reduce energy poverty and generate a low-carbon economic cycle. It will experiment with the newest smart solutions to maximise energy self-consumption, storage and decentralised energy resources. And it will foster flexibility through real-time monitoring, predictive analytics and automated response. The project is carried out by AESS, ENEA, UNIBO, with the support of CAAB/FICO, Agenzia Sviluppo Pilastro, Emilia Romagna Region, GSE, RSE, City of Bologna, local associations, businesses and citizens. It also aims to generate insights for policymakers to transpose EU regulation into national law.",
        link: "https://www.gecocommunity.it",
      },
      {
        x: 137.5,
        y: 82,
        ...
        yCategory: "Micro Demonstration",
        description:
          "The Landscape Metropolis strategy was started in 2016 by a group of local stakeholders in Ferrara. Its main objective is the development of a sustainable mobility network in the Po river delta to improve connectivity between the City of Ferrara and surrounding municipalities, with the broader goal of regenerating the delta landscape and reversing trends of population loss affecting rural communities. The mobility network builds on elements of the human-made landscape: existing and renovated waterways, towpaths alongside canals, piers and bridges, cycle and bus lanes, railway lines and walking trails. A series of experiments are designed for citizens to experience new and clean ways of travel via water and land. Through an iterative approach and handson learning, the initiators of Landscape Metropolis want to understand how to make public transport and active mobility more attractive, incentivise people to permanently shift their everyday behaviours and reduce their car dependency. In the long run, the project’s stakeholders aim to align political support for policy shifts and unlock sustainable infrastructure investments needed to make Landscape Metropolis a reality.",
        link: "https://www.metropolidipaesaggio.it",
      },
      {
        x: 130.5,
        y: 89,
        ...
        yCategory: "Micro Demonstration",
        description:
          "This project transforms the most-visited square kilometre of Europe into a future proof, sustainable and prosperous area: Amsterdam’s famous “Red Light District” will shift from “red” to “green”. The Green Light District project activates the local community to co-create numerous projects, such as recycling hubs, retrofitting buildings for energy efficiency, waste-free shops or sustainable food bars. It supports sustainable initiatives by local residents and entrepreneurs to not only make the district greener – quite literally on pavements and roofs – but also to support social cohesion and a positive view of the historic neighbourhood. With a strong consortium of challenge owners, citizens, municipal authorities and sustainability experts, it aims for systemic change in an urban environment which is scalable to the national and European level. The project will also develop a digital tool that can support the transformation of other historic neighbourhoods through tailor-made advice and personalised roadmaps.",
        link: "https://www.greenlightdistrict.nu",
      },
      {
        x: 135,
        y: 69,
      ...
      },
      {
        ...
        yCategory: "Micro Demonstration",
        description:
          "The Earth’s ecosystems provide humanity with a wide range of benefits known as “ecosystem goods and services”. These include services like water supply, air purification, natural recycling of waste, soil formation and more. Ecosystem services can be sold by one organisation managing an area (for example a forest owner) to another that wants to compensate for its environmental impact. One of the major challenges for ecosystem services is how to develop indicators and how to estimate the value of the services produced. The MADAMES-AX project works with forest owners, wood industry and schools in the Mediterranean Area to validate a scalable business model to support the sustainable management of forest ecosystems.",
        link: "https://www.madames-ax.info",
      },
      {
        x: 145,
        y: 72.5,
      ...
      },
      {
        ...
        yCategory: "Micro Demonstration",
        description:
          "Unsustainable, inefficient energy and transport systems, the ineffective use of public and private resources and a lack of citizen awareness are some of the main hurdles for EU cities in tackling climate change. Merezzate+ is a living lab that aims to integrate clean energy, energy efficiency, sustainable mobility and circular economy in a sprawling urban development project. The project seeks to boost the use of technical and socially inclusive solutions by integrating them into the affordable housing district, REDO Milano in southeast Milan. 615 of the project’s 800 apartments are dedicated to social housing. The idea is to engage residents, local public actors, and stakeholders such as housing associations and utilities in co-designing user-centred activities to bolster their effectiveness, create community and foster grassroots initiatives. The knowledge gained from Merezzate+ will help guide similar initiatives in Milan and other European cities.",
        link: "https://www.merezzateplus.it",
      },
    ],
  },
  {
    ...
    data: [
      {
        ...
        yCategory: "Market intervention: Risk Systems and Markets",
        description:
          "There’s a clear gap between weather and climate risk information generators (catastrophic risk modellers, national weather agencies, flood risk experts) and those who need actionable information. Unlocking City Climate Risk Information (UCCRI) deploys services to accelerate the use of weather and climate risk information by people residing in informal settlements and by official city stakeholders. The project will address the user needs of 10 vulnerable cities in Africa, Asia and the Caribbean. It will provide these cities with activities, tools and approaches that avoid single-point technology innovation, and will co-design and implement solutions with multiple stakeholders, using a proven set of methods, tools and platforms relevant to weather and climate risk information.",
        link: "https://www.resurgence.io",
      },
      {
        x: 27.5,
        y: 56.5,
      ...
      },
      {
        ...
        yCategory: "Market intervention: Finance instruments",
        description:
          "Buildings are likely to suffer significant damage costs from the impact of climate change. They are energy-intensive to build and operate, so they are key targets in global efforts to reduce carbon emissions. As two-thirds of the current building stock in most countries is expected to be in place in 2050, many will need deep and potentially costly retrofits to increase energy efficiency and switch to lower carbon power sources. The goal of the Real Estate Climate Asset Mapping Project (RECAM) is to provide a data-based solution to quantify how climate change may impact the value of real estate assets. The aim is that real estate asset owners use this data to make decisions that will lead to a more efficient use of energy and natural resources. The data should also help to shift capital towards buildings that are less carbon intensive and located in areas less likely to suffer from damaging climate events. The work will help financial players report their progress to the market and so fulfil upcoming regulations.",
      ...
      },
      {
        ...
        yCategory: "Market intervention: Risk Systems and Markets",
        description:
          "Short time horizons and the difficulty of estimating impacts based on near-term climate forecasts make it increasingly difficult for cities to act on climate change and related natural disasters. The project Climate Risk Information for SupportIngADAptation Planning and operaTion– Phase II (CRISI-ADAPT II) will develop an innovative tool to assess climate change impacts early on and prevent them at the local level. This tool aims to challenge cities to monitor and improve their adaptation planning. The project will focus on four strategic sectors: flooding/emergency response, water management for agriculture, energy planning and ports. This and other available tools and data will be used to support city governments, modellers, investors, and traders related to all sectors potentially affected by climate impacts.",
        link: "https://www.crisi-adapt2.eu",
      },
      {
        x: 6.5,
        y: 29,
        ...
        description:
          "Agriculture, forestry and land use contribute a significant portion (25 per cent) of global greenhouse gas emissions, increasing the imbalance between carbon release in the atmosphere and removal by natural sinks. Tackling this problem requires strategies to remove carbon from the atmosphere and store it over a long period in a stable form. Soils provide a large global reservoir of stabilised carbon, and soil carbon sinks can therefore reduce emissions. The organic fraction of municipal solid waste (OFMSW) offers an opportunity to recover nutrients and return them to the soil. Anaerobic Digestion is the most common of these solutions, and not only can help return nutrients to the soil, but also offsets fossil-fuel energy production by generating biogas. The C2Land project will create a viable scaling model to market a new soil amendment product – residual material from the anaerobic digestion of OFMSW which underwent hydrothermal carbonization and, possibly, composting. The project will evaluate soil performance and how the production process might increase capacities for biogas production.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 25,
        ...
        description:
          "Saferplaces employs innovative climate, hydrological (occurrence of water) and hydraulic (movement of water), topographic and economic modelling techniques to assess rain, river and coastal flood hazards and risks in urban environments under current and future climate scenarios. The project will test an advisory service on flood-risk mitigation measures and will inform on climate adaptation and disaster risk reduction strategies. Co-design and co-development activities will help foster multi-stakeholder agreements and partnerships to improve urban resilience.",
        link: "https://www.saferplaces.co",
      },
      {
        x: 20.5,
        y: 62.5,
    ...
    data: [
      {
        ...
        description:
          "The OpenSurface project explores new ways of monitoring land-use changes on the ground, such as deforestation. Currently, most of these changes go unnoticed, and those that are noticed typically need to be verified by a person – which makes monitoring at this scale too intensive and time-consuming to be practical. The OpenSurface tool applies new AI techniques to satellite imagery, augmenting this with drones, mobile device data and other sources where available. By connecting automatically verified changes on the ground to tailored alerts, or any digital service, the tool can drive the right response at the right time. Additionally, it gives stakeholders (governments, companies, individuals) the real-time data-base and transparency they need for effective climate action. This, in turn, enables new kinds of financial instruments and mechanisms. These can work across borders and industries to channel capital towards climate action, at scales – both large and small – not previously viable.",
        link: "https://www.opensurface.io",
      },
      {
        x: 91.5,
        y: 11.5,
      ...
      },
      {
        ...
        yCategory: "Market intervention: Finance instruments",
        description:
          "The kitchen is a central place in the home for both cooking and social interaction and is renovated more often than the house itself. Previous studies have shown that premature alterations and replacements of the kitchen and its appliances lead to unnecessary material flows and high climate impact. The way they are currently made, sold, placed, used and discarded contributes to avoidable material use, environmental pollution and greenhouse gas emissions. The Circular Kitchen project develops easily adaptable modules made from high-quality, environmentally friendly materials. This concept enables a kitchen design that can easily produce variants tailored to individual preferences, and that allows the continuous reuse of components. The high-quality materials cause higher initial costs, counterbalanced with long durability and much lower environmental impact.",
      ...
      },
      {
        ...
        yCategory: "Physical product",
        description:
          "DryGro is an agriculture technology company that has developed a new way to grow an animal feed protein ingredient called lemna. Lemna is a perfect supplement to the current industry standard for animal feed protein, soy. The project aims to tackle the global scarcity in protein ingredients for animal feed. This scarcity is currently especially acute in countries like Kenya, where it is difficult and expensive to obtain high-quality ingredients. Over the next few decades, this will become a much larger problem, as production will simply be unable to keep up with demand. To increase soy production capacity, rainforests in Brazil might be clear-cut. The technology for producing lemna allows DryGro to address this problem in two ways. First, lemna can grow on arid land that is currently not suitable for crops. Second, it grows at a much higher productivity rate than soy – at scale, over 10 times greater per unit area. Thus, this technology can reduce demand pressure on local soy markets and limit the need for mass deforestation.",
        link: "https://www.drygro.com",
      },
      {
        x: 62.5,
        y: 22,
        ...
        yCategory: "Service",
        description:
          "The Circular Housing project aims to develop an innovative circular economy model in the real estate sector. The project evaluates a model in which tenants can rent appliances and furniture – from refrigerators to bookshelves, which will be refurbished after the tenant leaves the apartment. A user-centred approach will help define a business model that takes the needs and desires of different actors into consideration, defining an ideal solution for all stakeholders. The involvement of relevant actors in the value chain, such as producers and waste management operators, will help identify innovative solutions that are adaptable and replicable in different environments.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 17,
      ...
      },
      {
        ...
        yCategory: "Product Accelerator",
        description:
          "Many UK cities have set ambitious targets for emissions reduction – Nottingham as early as 2028, Bristol, Edinburgh, Glasgow and Newcastle by 2030, London by 2050. And many are struggling with how to deliver at the scale and speed required. The Zero Carbon Delivery project provides knowledge and insights to UK city and regional authorities so they can translate their net zero-carbon ambitions into action. A partnership of leading UK practitioners on the built environment, mobility, energy, materials and finance will help these cities develop a holistic and integrated portfolio of innovative approaches. The Zero Carbon Lab responds directly to their need for added support, capacity and capability in achieving these ambitions. It will test and seed-fund the model with a view to it becoming a scalable and commercial model.",
      ...
      },
      {
        ...
        yCategory: "Product Accelerator",
        description:
          "Cities emit vast amounts of waste heat below 100°C. But existing infrastructure only allows its use for domestic and industrial heating applications – and not always. The efficient transformation of waste heat into local and distributed electricity has not yet been feasible, but it would contribute immensely and immediately to a cleaner environment and systemic change in city energy. Converting magnetic energy into thermal energy is one way to harness this waste heat. Magnetocaloric materials heat up when exposed to a magnetic field and cool down once this field is removed. The project Local, magnetocaloric power conversion opportunities for cities aims to tackle a variety of challenges to allow the successful development, implementation and commercialisation of a magnetocaloric heat exchanger for cities. The project explores whether the current and expected advancements in this technology would meet customer expectations, ensure profitable operations and have a positive environmental impact in cities.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 72,
        ...
        yCategory: "Product Accelerator",
        description:
          "Plastic is everywhere. While it can play a useful role in the economy, it is often not designed for re-use or low-cost recycling. Systemic change is needed so communities can adopt and establish new behaviours and solutions to replace products made of single-use plastics (SUP). The project Single-use plastic-free systemic local applications along the Mediterranean east coast aims to support engagement between private and public actors in local communities on single-use plastics (non-SUP) innovations. The project will launch an online platform to help improve awareness, strategies and solutions in three Mediterranean countries: Italy, Croatia, and Greece. The objective is to design and implement innovative experiments at the local level with citizens to set up replicable voluntary protocols for the use of non-SUP food packaging.",
        link: "mailto:communitydesk@climate-kic.org",
      },
      {
        x: 53.5,
      ...
      },
      {
        ...
        link: "https://www.nitrogensensor.eu",
      },
    ],
  },
];
